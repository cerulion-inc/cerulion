...
public partial class Right_Hip_Yaw : Link {
	private void SetupParameters() {
		is_root = false;
		link_name = "Right_Hip_Yaw";
		parent_name = "Base";
		joint_axis = new Vector3(0.0f, 0.0f, 1.0f);
		joint_pos_rel_parent = new Vector3(-0.00565f, -0.082f, -0.05735f);
		joint_rpy_rel_parent = new Vector3(0.0f, -0.174533f, 0.0f);
